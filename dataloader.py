...
class AutoRegressionChatData(Dataset):
    """Dataloader for Reaction-Dialogue Model based on GPT2"""
    ...
    def __getitem__(self, idx):
        ...
        reaction_cls = turn['reaction_cls']

        # concatenate reply and reaction class
        reply = str(reply) + self.delimiter + str(reaction_cls)
...
class Seq2SeqChatData(Dataset):
    """Dataloader for Reaction-Dialogue Model based on BART"""
